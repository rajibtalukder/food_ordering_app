...
MenuItemModel menuItemModelFromJson(String str) => MenuItemModel.fromJson(json.decode(str));

String menuItemModelToJson(MenuItemModel data) => json.encode(data.toJson());

class MenuItemModel {
  List<MenuItemModelDatum> data;
  Links links;
  Meta meta;
  ...
  factory MenuItemModel.fromJson(Map<String, dynamic> json) => MenuItemModel(
    data: List<MenuItemModelDatum>.from(json["data"].map((x) => MenuItemModelDatum.fromJson(x))),
...
class MenuItemModelDatum {
  ...
  factory MenuItemModelDatum.fromJson(Map<String, dynamic> json) => MenuItemModelDatum(
